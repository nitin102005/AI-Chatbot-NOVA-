...
const Home = ({ onTryChatbot }) => {
  ...
  <div className="sm:ml-5 ml-0 sm:-mt-10 mt-6">
    ...
    <div className="pl-2 mt-1 flex gap-4">
     <button onClick={onTryChatbot} className="bg-white rounded-lg sm:px-6 sm:py-3 cursor-pointer sm:text-[16px] text-[14px] px-3 py-2 sm:h-fit ">Try the Chatbot</button>
...
<div className='sm:h-16 h-10 sm:w-fit w-[94vw] p-2 ml-5 flex sm:mt-0 mt-3 flex-row gap-x-7 sm:bottom-24 bottom-0 gap-y-3 relative sm:ml-16 flex-wrap'>
 ...
 <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="sm:size-10 size-7">
  ...
  <div className='flex sm:hidden gap-x-7 gap-y-3'>

  <div className='sm:w-[215px] w-[153px] bg-black/20 text-white rounded-xl border h-fit border-white/10 shadow-lg p-4 flex gap-3 justify-center items-center'>
  ...
  <h1 className='sm:text-[16px] text-[10px] '>No Login Required</h1>
  </div>
  </div>
  </div>
